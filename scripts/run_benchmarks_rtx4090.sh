...
COMMON="--hidden-dim 256 --num-layers 12 --num-heads 8 --batch-size $BATCH_SIZE --amp $AMP --data-root $DATA_ROOT --epochs $EPOCHS --gradient-checkpointing --delta-backend $DELTA_BACKEND --early-stopping $EARLY_STOPPING"
