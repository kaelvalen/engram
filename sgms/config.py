"""SGMS configuration (spec §3, §4).

Single source of truth for the SGMS architecture: expert bank, router,
...
class SGMSConfig:
    ...
    # Expert bank (§3.2). Names from sgms.registry.EXPERT_NAMES.
    ...
    @classmethod
    def from_dict(cls, d: dict) -> "SGMSConfig":
        return cls(**{k: v for k, v in d.items() if k in cls.__dataclass_fields__})

    @classmethod
    def from_yaml(cls, path: str) -> "SGMSConfig":
        with open(path) as f:
