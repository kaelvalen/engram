...
from sgms.analysis.composition import reference_composition, time_averaged_utilization
from sgms.analysis.dynamics import (
    accuracy_trajectory,
    entropy_trajectory,
    pearson,
...
def _model(seed=0, **ov):
    ...
    return build_model("sgms", cfg, vocab_size=64)
